...
let oldHR: [Int] = [80, 76, 79, 70]

if let hrAverage: Int = heartRate {
    let total: Int = oldHR.reduce(0, +) + hrAverage
    print(total / (oldHR.count + 1))
} else {
    let total: Int =  oldHR.reduce(0, +)
    print(total / oldHR.count)
}
